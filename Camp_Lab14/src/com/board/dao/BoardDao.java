...
public class BoardDao {
	...
	private final String B_SAVE = "insert into BOARD (title, writer, content) values (?,?,?)";
	private final String B_UPDATE = "update BOARD set title=?, writer=?, content=? where seq=?";
