...
<script>
	function delete_ok(id) {
		...
		if (a)
			location.href = './comout/delete_ok.jsp?id=' + id;
	}
</script>
</head>
<body>
	<div class="all_container">
		...
		<div class="middle_container">
			<%
				...
				List<Communityout> list = CommunityoutDAO.list();
				...
				<thead>
					<tr>
						...
						<td class="d-print-none"><a class="btn btn-sm btn-success"
							href="./comout/addform.jsp">Add</a></td>
					</tr>
				<thead>
				<tbody>
					<c:forEach items="${list}" var="u">
						<tr>
							...
							<td><a class="btn btn-sm btn-warning"
								href="./comout/editform.jsp?id=${u.getSeq()}">EDIT</a> <a
								class="btn btn-sm btn-danger"
								href="javascript:delete_ok('${u.getSeq()}')">DELETE</a> <a
								class="btn btn-sm btn-info" href="./comout/view.jsp?id=${u.getSeq()}">VIEW</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
