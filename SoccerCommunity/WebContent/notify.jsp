<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="com.board.dao.NotifyDao,com.board.bean.Notify,java.util.*"%>
...
<script>
	function delete_ok(id) {
		...
		if (a)
			location.href = './crud/delete_ok.jsp?id=' + id;
	}
</script>
</head>
<body>
				...
				<thead>
					<tr>
						...
						<td class="d-print-none"><a class="btn btn-sm btn-success"
							href="./notify/addform.jsp">Add</a></td>
					</tr>
				<thead>
				<tbody>
					<c:forEach items="${list}" var="u">
						<tr>
							...
							<td><a class="btn btn-sm btn-warning"
								href="./notify/editform.jsp?id=${u.getSeq()}">EDIT</a> <a
								class="btn btn-sm btn-danger"
								href="javascript:delete_ok('${u.getSeq()}')">DELETE</a> <a
								class="btn btn-sm btn-info" href="./notify/view.jsp?id=${u.getSeq()}">VIEW</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
